...
sha='d1f8e8393203d27f46e793b6e73e41b4dbbd9110' #override sha
'''
...
"technique": "SRI trigger search + prediction change","technique_description": "Check models' response on a set of pre-determined patch triggers and measure change in model's response","technique_changes": "More predetermined patch triggers 27->64. Improved Trojan classifier architecture. Added some missing terms in 2nd order invariance pooling.","technique_type": ["Trigger Inversion"],"commit_id": sha,"repo_name": url,"required": [],"additionalProperties": False,"type": "object"}
